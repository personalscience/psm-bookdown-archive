...
knitr::include_graphics("./Next/assets/virusSizeAndStructure.jpg")
...
knitr::include_graphics("./Next/assets/virusEnteric.jpg")
```
...
References: Virgin, H.W. (2014). The virome in mammalian physiology and disease. Cell 157, 142–150.
