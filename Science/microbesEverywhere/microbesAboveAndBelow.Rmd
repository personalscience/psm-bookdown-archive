...
Closer to the surface, [a 2015 Chinese study](https://www.nature.com/articles/ncomms9159) showed that 86% of the variation in above-ground life is determined by variation in the life below ground, mostly bacteria that sustain the ability of roots to take nutrients out of the soil.
...
```{r echo=FALSE}
knitr::include_graphics("Science/assets/scienceMicrobesSky.jpg")
```
...
Microbes seem capable of living off just about anything. _Ideonella sakaiensis_, discovered in 2016 by a Japanese team^[http://www.sci-news.com/biology/ideonella-sakaiensis-bacterium-can-break-down-metabolize-plastic-03693.html], can break down and metabolize plastic. Termites owe their wood-eating abilities to a whole community of synergistic bacteria, archaea, and protists. Aphids can't live off sap without  _Buchnera_, a microbe that supplies them with essential amino acids.  Some microbes even play a role in the mineralization of copper and gold.^[http://pubs.rsc.org/en/Content/ArticleLanding/2018/MT/C7MT00312A#!divAbstract]
...
```{r echo=FALSE}
knitr::include_graphics("Science/assets/scienceRadiodurans.jpg")
```
