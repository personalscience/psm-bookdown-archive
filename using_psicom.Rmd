...
1. Upload your own raw data and tag it with descriptive attributes. (Figure \@ref(fig:usingPsicomMainScreen1))
...
knitr::include_graphics("./using_psicom/using_psicom_main_screen1.png")
...
knitr::include_graphics("./using_psicom/using_psicom_upload_json1.png")
...
knitr::include_graphics("./using_psicom/using_psicom_community_lyme1.png")
...
To compare your sample with others, click on one of the checkboxes for the query you saved on the previous tab. For example, this is what we see when we click the `lymesamples` query (Figure \@ref(fig:usingPsicomCompareLyme1)):


```{r usingPsicomCompareLyme1, fig.cap = "Select the 'lymesamples' query to see how your sample(s) marked with '*' compare with others", echo = FALSE, warning = FALSE, message = FALSE}
knitr::include_graphics("./using_psicom/using_psicom_compare_lyme1.png")
...
knitr::include_graphics("./using_psicom/using_psicom_compare_sutterella1.png")
