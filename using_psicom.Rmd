...
```{r using_psicom_main_screen, fig.cap = "After uploading a sample, your main screen will look something like this.", echo = FALSE, warning = FALSE, message = FALSE}
...
```{r using_psicom_upload_json, fig.cap = "Copy and paste your raw uBiome JSON data here.", echo = FALSE, warning = FALSE, message = FALSE}
...
```{r using_psicom_compare_lyme1, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r using_psicom_compare_sutterella1, echo = FALSE, warning = FALSE, message = FALSE}
