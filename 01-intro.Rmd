...
Indiegogo^[https://www.indiegogo.com/projects/ubiome-sequencing-your-microbiome], but has since handled tens of thousands of samples from people like me who are curious to know what a 16S analysis will reveal about their own microbiome. Order a kit online at the [uBiome web site](https://shop.ubiome.com/pages/buynow).  We recommend the standard "Gut Kit" ($89). Be sure to use the offer code `PERSONAL SCIENCE` to get 15% off your order.

Just send them a sample and a few weeks later they give you access to a private web page that will show you a breakdown of the types of bacteria they found.

For microbiome hackers, the best part about uBiome is the raw data. 

### Thryve
Founded after CEO Richard Lin became frustrated at the lack of actionable microbiome insights to cure his own recurrent gut issues, [ThryveInside.com](https://thryveinside.com) is another standard 16S-based analysis. 
