...
Indiegogo^[https://www.indiegogo.com/projects/ubiome-sequencing-your-microbiome], but has since handled tens of thousands of samples from people like you who are curious to know more about their own microbiome. Order a kit online at the [uBiome web site](https://shop.ubiome.com/pages/buynow).  We recommend the standard "Gut Kit" ($89). Be sure to use the offer code `PERSONALSCIENCE` to get 15% off your order.
