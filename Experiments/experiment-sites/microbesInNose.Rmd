...
```{r plotSeasonality, fig.cap = "Nose microbiome across seasons. (NMDS ordination, Bray-Curtis similarity at Family rank"}
...
```{r nosePlotSeasonalityDiversityGeo, fig.cap = "Nose microbiome diversity in a single geography by season."}
