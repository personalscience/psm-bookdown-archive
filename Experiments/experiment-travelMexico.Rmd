...
```{r echo=FALSE}
knitr::include_graphics("./Experiments/assets/experimentTravelMexicoPulque.jpg")
...
m.db <- mhg_unique(mexico.during,mexico.before)
m.da <- mhg_unique(mexico.during,mexico.after)
...
```{r echo=FALSE}
knitr::include_graphics("./Experiments/assets/experimentTravelMexicoElusive.jpg")
```
...
```{r}
# m.bd <- mhg_unique(mexico.before,mexico.during)
# m.ad <- mhg_unique(mexico.after,mexico.during)
# m.ba <- mhg_unique(mexico.before,mexico.after)
# 
# mhg_unique(merge_phyloseq(mexico.before,mexico.after),mexico.during)$tax_name %in% rownames(mhg_abundance(mexico.during))
# 
# rownames(mhg_abundance(mexico.before)) %in% rownames(mhg_abundance(mexico.after))
kable(mhg_unique(merge_phyloseq(mexico.before,mexico.after),mexico.during)$tax_name,col.names = c("Disappeared"))
