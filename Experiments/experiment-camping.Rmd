...
```{r}
kable(mhg_unique(camping.after,camping.before)[1:10,][1]/10000, digits = 2, col.names = c("New after camping (%)"))
```
...
```{r}
kable(mhg_unique(camping.before,camping.after)[1]/10000, digits = 2, col.names = c("Before Camping (%)"))
```
