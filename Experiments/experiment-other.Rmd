...
[This paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5593975/) suggests a relationship between _Lachnospiraceae_ family and Omega-3. I tried taking high-omega 3 fish oil pills for a week. (Figure \@ref(fig:experimentOmega3))

```{r experimentOmega3, fig.cap="Days marked in red are days I took two fishoil capsules."}
...
plot_bar(subset_taxa(subset_samples(gut.family.norm, Date>"2017-01-01" ),   #, Date %in% seq(as.Date("2016-12-01"), length = 60, by = 1)),
...
Interestingly, looking back through my daily microbiome samples to see which dates I tried Soylent, I got this: (Figure \@ref(fig:experimentSoylentFBRatio))

```{r experimentSoylentFBRatio, fig.cap = "Red dots mark days when I drank Soylent."}
...
The shift is more dramatic if we look at a longer time frame, the weeks before and after the Soylent drinking (Figure \@ref(fig:soylentFBratio))

```{r soylentFBratio, fig.cap="Soylent-drinking days are highlighted in red."}
...
The nutritional label gives some possible clues. (Figure \@ref(fig:experimentSoylentLabel))

```{r experimentSoylentLabel, fig.cap = "Nutritional label and ingredients list from a bottle of Soylent."}
knitr::include_graphics("Experiments/assets/MHG-experimentSoylentLabel.jpg")
```
...
```{r experimentSoylentDiversity, fig.cap = "Family-level diversity. The period highlighted in red is days I drank Soylent."}
...
Finally, let's look at the overall phyla-level breakdown. (Figure \@ref(fig:experimentSoylentPhylaOverall))
```{r experimentSoylentPhylaOverall, fig.cap = "Phyla breakdown shows high Verrucomicrobia after Soylent drinking. Genus is Akkermansia."}
