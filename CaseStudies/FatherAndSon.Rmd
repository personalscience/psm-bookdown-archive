...
me.only <- mhg_unique(subset_samples(me.and.dad.genus,Username=="Me"),
          subset_samples(me.and.dad.genus,Username=="Dad")
          )

me.only.species <- mhg_unique(subset_samples(me.and.dad.species,Username=="Me"),
          subset_samples(me.and.dad.species,Username=="Dad")
          )

dad.only <- mhg_unique(subset_samples(me.and.dad.genus,Username=="Dad"),
          subset_samples(me.and.dad.genus,Username=="Me")
          )

dad.only.species <- mhg_unique(subset_samples(me.and.dad.species,Username=="Dad"),
