...
sink("junk.txt")
ord <- ordinate(subset_samples(people.family, Site=="gut"),method = "NMDS", distance = "bray")
plot_ordination(subset_samples(people.family, Site=="gut"),ord, color = "Condition", label = "Username")
sink()
