...
When fighting any terrible situation, false hope can be a greater danger than the disease itself if you become a victim of disreputable scammers, who are all-too-common in the world of health advice. Paul did the right thing by going first to an experienced oncologist, with whom he consults on everything, including the decision to test and study his microbiome.

If -- and I believe, when -- a microbiome-informed cure for cancers becomes available, it will be thanks to the tireless effort of doctors, as well as people like Paul who are willing to ask questions.
