...
_Gordonibacter_ produce urolithin A, a compound that apparently protects muscle cells from aging, at least in animals^[See a discussion in https://www.medicalnewstoday.com/articles/311572.php]

^[See this Reddit thread: https://www.reddit.com/r/Microbiome/comments/4vh6d7/increasing_andor_adding_gordonibacter/].

In our healthy database, we find this microbe is relatively rare. (Figure \@ref(fig:microbesGordonibacter))

```{r microbesGordonibacter, fig.cap = "Gordonibacter abundance in healthy people."}
...
See any microbe using this embedded app:

<iframe width="900" height="800" scrolling="yes" frameborder="no"  src="https://personalscience.shinyapps.io/microbeAbundance/"> </iframe>
