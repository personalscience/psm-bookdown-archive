...
This microbe, it seems, is pretty rare (Figure \@ref(fig:microbesGordonibacter)) in healthy people as well as everyone else.
...
See any microbe using [this app](https://personalscience.shinyapps.io/microbeAbundance/).
