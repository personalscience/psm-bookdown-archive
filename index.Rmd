...
If you suffer from a chronic condition, one of your first struggles is simply knowing the level of severity. What is the precise version or name of this disease? What makes me different from a healthy person, or from the healthy person I used to be? Are there other people with the same condition, and if so, how does my situation compare to theirs? Am I getting better or worse?

In other words, you want to know the *context*. A first step in approaching your situation is to simply understand how you compare…to healthy people, to those who have the same condition as you do, to people who have partially or fully recovered. Is your condition getting better or worse? Is it better or worse than other people like me?
